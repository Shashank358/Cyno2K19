...
public class MotorballEvent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_motorball_event);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("MotorBall");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String to="";
                String sub="Regarding MotorBall:";
        ...
        toolbarLayout.setTitle("MotorBall");
    ...
    public void callHead1 (View v)
    {
        ...
        intent.setData(Uri.parse("tel:+919673561442"));
    ...
    {
        Intent intent = new Intent(Intent.ACTION_DIAL);
        intent.setData(Uri.parse("tel:+918805534299"));
        startActivity(intent);
    }
}
