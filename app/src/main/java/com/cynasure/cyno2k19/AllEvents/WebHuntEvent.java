...
public class WebHuntEvent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_web_hunt_event);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Web Hunt");
        ...
        toolbarLayout.setTitle("Web Hunt");
    ...
    public void callHead1 (View v)
    {
        ...
        intent.setData(Uri.parse("tel:+917841938885"));
    ...
    {
        Intent intent = new Intent(Intent.ACTION_DIAL);
        intent.setData(Uri.parse("tel:+918888561580"));
        startActivity(intent);
    }
}
