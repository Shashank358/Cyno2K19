...
public class WaterRocketEvent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_water_rocket_event);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Water Rocket");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String to="";
                String sub="Regarding Water Rocket:";
        ...
        toolbarLayout.setTitle("Water Rocket");
    ...
    public void callHead1 (View v)
    {
        ...
        intent.setData(Uri.parse("tel:+917843031995"));
    ...
    {
        Intent intent = new Intent(Intent.ACTION_DIAL);
        intent.setData(Uri.parse("tel:+919405603220"));
        startActivity(intent);
    }
}
