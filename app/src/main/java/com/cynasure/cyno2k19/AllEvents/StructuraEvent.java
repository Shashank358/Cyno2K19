...
public class StructuraEvent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_structura_event);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Structura");
        ...
        toolbarLayout.setTitle("Structura");
    ...
    public void callHead1 (View v)
    {
        ...
        intent.setData(Uri.parse("tel:+918421544074"));
    ...
    {
        Intent intent = new Intent(Intent.ACTION_DIAL);
        intent.setData(Uri.parse("tel:+918450911296"));
        startActivity(intent);
    }
}
