...
public class ElectroPlazaEvent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electro_plaza_event);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Electro Plaza");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String to="";
                String sub="Regarding ElectroPlaza:";
        ...
        toolbarLayout.setTitle("Electro Plaza");
    ...
    public void callHead1 (View v)
    {
        ...
        intent.setData(Uri.parse("tel:+917756996092"));
    ...
    {
        Intent intent = new Intent(Intent.ACTION_DIAL);
        intent.setData(Uri.parse("tel:+919923755629"));
        startActivity(intent);
    }
}
