...
public class YantramEvent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yantram_event);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Yantram");
        ...
        toolbarLayout.setTitle("Yantram");
    ...
    public void callHead1 (View v)
    {
        ...
        intent.setData(Uri.parse("tel:+918806835217"));
    ...
    {
        Intent intent = new Intent(Intent.ACTION_DIAL);
        intent.setData(Uri.parse("tel:+917448044274"));
        startActivity(intent);
    }
}
