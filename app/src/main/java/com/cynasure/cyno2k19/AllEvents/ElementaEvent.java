...
public class ElementaEvent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elementa_event);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Elementa");
        ...
        toolbarLayout.setTitle("Elementa");
    ...
    public void callHead1 (View v)
    {
        ...
        intent.setData(Uri.parse("tel:+919923077868"));
    ...
    {
        Intent intent = new Intent(Intent.ACTION_DIAL);
        intent.setData(Uri.parse("tel:+918237983768"));
        startActivity(intent);
    }
}
