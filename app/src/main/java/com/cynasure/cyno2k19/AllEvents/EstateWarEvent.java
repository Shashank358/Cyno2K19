...
public class EstateWarEvent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_estate_war_event);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Estate War");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String to="";
                String sub="Regarding Estate War:";
        ...
        toolbarLayout.setTitle("Estate War");
    ...
    public void callHead1 (View v)
    {
        ...
        intent.setData(Uri.parse("tel:+917744945114"));
    ...
    {
        Intent intent = new Intent(Intent.ACTION_DIAL);
        intent.setData(Uri.parse("tel:+919552979524"));
        startActivity(intent);
    }
}
