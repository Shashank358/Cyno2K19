...
public class MRDEvent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mrdevent);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("MRD");
    ...
    public void callHead1 (View v)
    {
        ...
        intent.setData(Uri.parse("tel:+91976678337"));
    ...
    {
        Intent intent = new Intent(Intent.ACTION_DIAL);
        intent.setData(Uri.parse("tel:+91865283045"));
        startActivity(intent);
    }
}
