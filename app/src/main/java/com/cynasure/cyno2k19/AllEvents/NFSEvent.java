...
public class NFSEvent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nfsevent);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("NFS");
    ...
    public void callHead1 (View v)
    {
        ...
        intent.setData(Uri.parse("tel:+918669809879"));
    ...
    {
        Intent intent = new Intent(Intent.ACTION_DIAL);
        intent.setData(Uri.parse("tel:+918275018408"));
        startActivity(intent);
    }
}
