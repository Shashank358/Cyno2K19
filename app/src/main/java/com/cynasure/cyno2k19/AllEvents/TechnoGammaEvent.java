...
public class TechnoGammaEvent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_techno_gamma_event);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("TechnoGamma");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String to="";
                String sub="Regarding TechnoGamma:";
        ...
        toolbarLayout.setTitle("TechnoGamma");
    ...
    public void callHead1 (View v)
    {
        ...
        intent.setData(Uri.parse("tel:+919503727284"));
    ...
    {
        Intent intent = new Intent(Intent.ACTION_DIAL);
        intent.setData(Uri.parse("tel:+917558362363"));
        startActivity(intent);
    }
}
